                ...
                <div>
                    {isLoading ? (
                        ...
                        <div className="flex flex-row items-center space-x-2">
                            <Rating
                                name="half-rating"
                                value={data?.analytics?.average || 0}
                                precision={0.5}
                                sx={{
                                    color: "inherit",
                                }}
                            ...
                            <span className="text-sm font-bold text-gray-600">
                                {data?.analytics?.reviewCount || 0} reviews
                            </span>
                        </div>
                    )}
                </div>
